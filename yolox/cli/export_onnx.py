...
def make_parser():
    ...
    parser = argparse.ArgumentParser(
        "yolox export_onnx",
        description="Export a trained YOLOX model to ONNX format",
        epilog="""
Examples:
  # Basic export with default settings
  yolox export_onnx -w model.pth -cfg yolox_s

  # Export with custom image size
  yolox export_onnx -w model.pth -cfg yolox_s --imgsz 640 640

  # Export with dynamic batch size
  yolox export_onnx -w model.pth -cfg yolox_s --dynamic

  # Export with dynamic input shape
  yolox export_onnx -w model.pth -cfg yolox_s --dynamic-shape

  # Export with ONNX simplification
  yolox export_onnx -w model.pth -cfg yolox_s --simplify
        """,
